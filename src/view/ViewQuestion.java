...
public class ViewQuestion implements CodepointCallbackInterface {
	...
	/* (non-Javadoc)
	 * @see com.googlecode.blacken.terminal.editing.CodepointCallbackInterface#handleCodepoint(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.googlecode.blacken.terminal.editing.CodepointCallbackInterface#handleMouseEvent(com.googlecode.blacken.terminal.BlackenMouseEvent)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.googlecode.blacken.terminal.editing.CodepointCallbackInterface#handleResizeEvent()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.googlecode.blacken.terminal.editing.CodepointCallbackInterface#handleWindowEvent(com.googlecode.blacken.terminal.BlackenWindowEvent)
	 */
	@Override
