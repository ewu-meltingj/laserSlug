...
public class Player implements I_GetObserved {
	...
	public Player(Room newRoom) {
		...
		_oldPosition = new Coordinate(_yCoordinate, _xCoordinate);
		_hasQuit = false;
	 ...
	 */
	public Coordinate getPlayerPositionPrev() {
		return _oldPosition;
	}
	...
	public Coordinate getPosition() {
		return new Coordinate(_yCoordinate, _xCoordinate);
	}
	 ...
	 * @return the point
	 */
	public Coordinate possible(Coordinate direction) {
		return Coordinate.translate(this.getPosition(), direction);
	}
	 ...
	 */
	public void setPlayerPosition(Coordinate position) {
	 ...
	 */
	public void setPlayerPositionPrev(Coordinate prev) {
		_oldPosition = prev;
	}
